...
<div class="modal-header">
    ...
    <h4 class="modal-title">Create Developer Group</h4>
</div>
<div class="modal-body">
    <form class="ajax-submit" action="{{route('developergroup.store')}}" method="post" onsubmit="event.preventDefault(); directSubmit(this);">
