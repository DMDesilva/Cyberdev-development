    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>All positions in the system</small>
            </h1>
        </section>
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-block btn-primary btn-sm" onclick="addClick()">Add Position</button>
                    </div>
                </div>
                <div class="box-body">
...
@push('script')
    ...
    <script src="{{asset('assets/js/position.js')}}"></script>
@endpush