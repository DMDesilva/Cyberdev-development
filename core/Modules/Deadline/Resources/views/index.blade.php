...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
     Deadline Tracking
      <small>All Task Tracking Hear</small>
    </h1>
  </section>
    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <button type="button" class="btn btn-block btn-primary btn-sm" onclick="addClick()">Add Deadline</button>
        </div>
      </div>
      <div class="box-body">
...
<script type="text/javascript">
  let resource = 'deadline';
</script>
<script src="{{asset('assets/js/crud.js')}}"></script>
<script src="{{asset('assets/js/deadline.js')}}"></script>
@endpush