...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Developer Mail Management
                <small>All developer mails in the system</small>
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Developer Mail List</h3>

                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-block btn-primary btn-sm" onclick="addClick()">Add Developer Mail</button>
                    </div>
                </div>
                <div class="box-body">
...
@push('script')
    ...
    <script type="text/javascript">
        let resource = 'developermail';
    </script>
    <script src="{{asset('assets/js/crud.js')}}"></script>
    <script src="{{asset('assets/js/developermail.js')}}"></script>
